...
- Note 1: The idea is not to sort the elements from the lowest value to the highest; the idea is to traverse the 2-D array in a clockwise snailshell pattern.
